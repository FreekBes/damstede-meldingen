						...
						foreach($nots["messages"] as $msg) {
							...
							<tr class="notsrow<?PHP echo $msg["extra_class"]; ?>">
								...
								<?PHP if ($msg["type"] == "default") { ?>
									<td class="center nowrap"><a class="notoption" title="Melding bewerken" href="javascript:void()" onclick="setEditFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', '<?PHP echo addslashes(preg_replace("/\r|\n/", "", $msg["content"])); ?>', '<?PHP echo date('Y-m-d', intval($msg["start-date"])); ?>', '<?PHP echo date('Y-m-d', intval($msg["end-date"])); ?>'); showAction('noteditor');">&#x270e;</a><a class="notoption" title="Melding verwijderen" href="javascript:void()" onclick="setDeleteFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', '<?PHP echo addslashes(preg_replace("/\r|\n/", "", $msg["content"])); ?>'); showAction('notdeletor');">&#x1f5d1;</a></td>
								<?PHP } else if ($msg["type"] == "image") { ?>
									<td class="center nowrap"><a class="notoption" title="Melding bewerken" href="javascript:void()" onclick="setEditFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', null, '<?PHP echo date('Y-m-d', intval($msg["start-date"])); ?>', '<?PHP echo date('Y-m-d', intval($msg["end-date"])); ?>'); showAction('noteditor');">&#x270e;</a><a class="notoption" title="Melding verwijderen" href="javascript:void()" onclick="setDeleteFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', '<img src=\'<?PHP echo $msg["src"]; ?>\' style=\'max-width: 420px; max-height: 420px;\' />'); showAction('notdeletor');">&#x1f5d1;</a></td>
								<?PHP } else if ($msg["type"] == "video") { ?>
									<td class="center nowrap"><a class="notoption" title="Melding verwijderen" href="javascript:void()" onclick="setDeleteFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', '<video controls muted src=\'<?PHP echo $msg["src"]; ?>\' style=\'max-width: 420px; max-height: 420px;\' />'); showAction('notdeletor');">&#x1f5d1;</a></td>
								<?PHP } else if ($msg["type"] == "zermelo") { ?>
									<td class="center nowrap"><a class="notoption" title="Melding verwijderen" href="javascript:void()" onclick="setDeleteFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', 'Geen voorbeeld om weer te geven'); showAction('notdeletor');">&#x1f5d1;</a></td>
								<?PHP } ?>
								...
								foreach($nots["messages"] as $msg) {
									...
									<li class="preview<?PHP echo $msg["extra_class"]; ?>" title="<?PHP echo $screen["name"]." (".($thisNots+1)."/".count($nots["messages"]).")"; ?>">
										...
										<div class="preview-options">
											...
											<?PHP if ($msg["type"] == "default") { ?>
												<a class="notoption" title="Melding bewerken" href="javascript:void()" onclick="setEditFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', '<?PHP echo addslashes(preg_replace("/\r|\n/", "", $msg["content"])); ?>', '<?PHP echo date('Y-m-d', intval($msg["start-date"])); ?>', '<?PHP echo date('Y-m-d', intval($msg["end-date"])); ?>'); showAction('noteditor');">&#x270e;</a><a class="notoption" title="Melding verwijderen" href="javascript:void()" onclick="setDeleteFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', '<?PHP echo addslashes(preg_replace("/\r|\n/", "", $msg["content"])); ?>'); showAction('notdeletor');">&#x1f5d1;</a>
											<?PHP } else if ($msg["type"] == "image") { ?>
												<a class="notoption" title="Melding bewerken" href="javascript:void()" onclick="setEditFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', null, '<?PHP echo date('Y-m-d', intval($msg["start-date"])); ?>', '<?PHP echo date('Y-m-d', intval($msg["end-date"])); ?>'); showAction('noteditor');">&#x270e;</a><a class="notoption" title="Melding verwijderen" href="javascript:void()" onclick="setDeleteFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', '<img src=\'<?PHP echo $msg["src"]; ?>\' style=\'max-width: 420px; max-height: 420px;\' />'); showAction('notdeletor');">&#x1f5d1;</a>
											<?PHP } else if ($msg["type"] == "video") { ?>
												<a class="notoption" title="Melding verwijderen" href="javascript:void()" onclick="setDeleteFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', '<video controls muted src=\'<?PHP echo $msg["src"]; ?>\' style=\'max-width: 420px; max-height: 420px;\' />'); showAction('notdeletor');">&#x1f5d1;</a>
											<?PHP } else if ($msg["type"] == "zermelo") { ?>
												<td class="center nowrap"><a class="notoption" title="Melding verwijderen" href="javascript:void()" onclick="setDeleteFormValues('<?PHP echo $screen["name"]; ?> (<?PHP echo $screen["location"]; ?>)', '<?PHP echo $msg["id"]; ?>', '<?PHP echo addslashes($msg["title"]); ?>', 'Geen voorbeeld om weer te geven'); showAction('notdeletor');">&#x1f5d1;</a></td>
											<?PHP } ?>
										</div>
